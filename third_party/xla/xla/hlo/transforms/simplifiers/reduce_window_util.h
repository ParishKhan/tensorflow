...
// Returns true if the computation is a SparseCore computation (either executing
// on kSparseCoreExecutionThread or containing/calling sparse operations).
bool IsSparseCoreComputation(const HloComputation* computation);
